...
def get_concept_service() -> ConceptService:
    ...
    async def extract_concepts_v7(
        ...
        for item in top_concepts:
            ...
            concept.methods_found = item['methods_found']
            concept.extraction_methods = item['methods']
            concept.structure_id = structure_id
            
            concepts.append(await self.create(concept))
